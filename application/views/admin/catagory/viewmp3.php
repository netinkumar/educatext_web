...
<div class="content-wrapper">
 ...
 <?php
    ...
    <a href="<?php echo base_url().'admin/catagory/addaudio' ?>" type="button" id="addmp3"  class="btn btn-block btn-success">Add mp3</a>
    ...
    $i=1;
    foreach($audio as $audiodata){ ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $audiodata->name; ?></td>
                  
                  <td> <audio controls>
<source src="<?php echo base_url().'assets/user/audio/'.$audiodata->name ?>" type="audio/mpeg">
Your browser does not support the audio element.
</audio></td>
                  <td>
                  <a class="btn btn-block btn-danger btn-flat" href="<?php echo base_url().'admin/catagory/deleteaudio/'.$audiodata->id ?>">Delete</a>
                  </td>
                </tr>
